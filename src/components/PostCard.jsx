...
function PostCard({ post }) {
  ...
  return (
  <div className="max-h-screen bg-transparent flex items-center justify-center group">
      <div 
      ...
      >
        <div 
          className={`relative w-full h-full transition-transform duration-700 transform-style-3d border-2 border-gray-200 rounded-2xl ${
        ...
        >
          {/* Ön Yüz */}
          <div 
            className="absolute w-full h-full backface-hidden bg-transparent rounded-2xl shadow-2xl p-4 flex flex-col items-center justify-center"
            style={{ backfaceVisibility: 'hidden' }}
          >
             <span 
            className={`absolute top-2 right-2 inline-block px-3 py-1 text-sm font-semibold text-white rounded-full
          ...
          >
           ...
           <div className="">
            ...
            <Link to={`/ilan/${id}`} className='absolute bottom-2 hover:text-blue-600 hover:underline transition-colors duration-200' >
